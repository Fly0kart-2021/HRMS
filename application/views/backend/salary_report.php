                                ...
                                <form method="post" action="" id="salaryform" class="form-material row">
                                    <div class="form-group col-md-3">
                                     <?php if($this->session->userdata('user_type')!='SUPER ADMIN'){
                                       echo '<input type="hidden" id="emiddd" value="'.$this->session->userdata('user_login_id').'" >';
                                     }
                                     else{?> 
                                        <select class="form-control custom-select"  tabindex="1" name="emid" id="emiddd" style="margin-top: 23px" required>
