                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <?php if($usertype=='EMPLOYEE')
                                                echo ' <a href="'. base_url().'leave/EmApplication" class="text-muted m-b-0">Pending Leave</a>';
                                                else
                                        echo '<a href="'.base_url().'leave/Application" class="text-muted m-b-0">Pending Leave</a>';
                                        ?>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-success card-inverse">
                            <div class="box text-center">
                                <h1 class="font-light text-white">
                                             ...
                                             {
                                                    $result= $this->db->query("SELECT emp_leave.id FROM emp_leave LEFT JOIN employee ON employee.em_id= emp_leave.em_id WHERE employee.em_role='EMPLOYEE' AND leave_status='Approve';")->result();
                                                    echo $this->db->count_all_results();
                                             }
