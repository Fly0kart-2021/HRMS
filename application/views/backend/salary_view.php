...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                  <center>
                            <div style="width:70%;display:none" id="myElem" class="alert alert-success"> <strong> Payroll Successfully  Processed.</strong>
                                <button type="button" class="close" onclick='(function(){ $(myElem).hide(); })();'>&times;</button>
                            </div>
                        </center>
                        <center>
                            <div style="width:70%;display:none" id="payElem" class="alert alert-danger"> <strong> Successfully Generated .</strong>
                                <button type="button" class="close" onclick='(function(){ $(payElem).hide(); })();'>&times;</button>
                            </div>
                        </center>
                    <form method="post" action="" id="salaryform" class="form-material row">
                      ...
                      <input  type="button" id="process" class="btn btn-success" value="Process">
                      
                    
                      <input  type="button" id="finalpay" class="btn btn-danger" value="Final PAY">
                      </div>
    ...
    <script>
      // Populate the payroll table to generate the payroll for each department
      $("#process").on("click", function(event) {
        ...
        debugger;
        $.ajax({
          url: " Process_payroll_by_dep?date_time=" + datetime + "&dep_id=" + depid,
          type: "POST",
          dataType: '',
          data: { 'id' : depid, 'datetime' : datetime },
          success: function(response) {
...
<script>
      // Populate the final payroll table to generate the payroll for each department
      $("#finalpay").on("click", function(event) {
        event.preventDefault();
        var depid = $('#depid').val();
        var datetime = $('.mydatetimepicker').val();
        debugger;
        $.ajax({
          url: "finalpaytodept?date_time=" + datetime + "&dep_id=" + depid,
          type: "POST",
          dataType: '',
          data: { 'id' : depid, 'datetime' : datetime },
          success: function(response) {
          ...
          <form method="post" action="pay_salary_add_record" id="generatePayrollForm" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="row well">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="control-label text-left col-md-5">Total Salary
                    </label>
                    <div class="col-md-7">
              ...
              <div class="form-group row" style="margin-top: 25px;">
                ...
                <div class="col-md-9">
                  ...
                  <input name="paid_type" type="radio" id="radio_4" data-value="Bank" class="type" value="Bank" checked="checked">
