                                        ...
                                        <div class="card">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php if ($this->session->userdata('user_type') == 'ADMIN' || $this->session->userdata('user_type') == 'SUPER ADMIN') {
                                                                ...
                                                                echo form_dropdown('prostatus', $status_dropdown, $details->pro_status, 'class="form-control custom-select"');
                                                            }
                                                            ...
                                                            <!-- <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="prostatus" 
                                                            <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> required>
                                            ...
                                            <option value="CLOSE">Close</option>
                                                        ...
                                                        foreach ($depvalue as $value) {
                                                            $options[$value->id] = $value->dep_name;
                                                        }
                                                        ?>
                                                        ...
                                                        <?php } elseif ($this->session->userdata('user_type') == 'ADMIN') {
                                                            ...
                                                            echo '<input type="hidden" name="Department" value="' . $details->dep_id . '" />';
                                                        } else { ?>
                                                            <div class="form-group">
                                                                <label class="control-label">Department</label>

                                                                <?php echo form_dropdown('Department', $options, $details->dep_id, 'class="form-control custom-select"');
                                                                ?>
                                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php } else { ?>
                                                                <td class="jsgrid-align-center ">
                                                                    ...
                                                                    <a onclick="alert('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light TasksDelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                                                </td>
                                                            <?php } ?>
                                                        </tr>
                                                    <?php endforeach; ?>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel1">Project Tasks</h4>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <select class="select2 form-control custom-select col-md-3" data-placeholder="Choose a Category" style="width:25%" tabindex="1" name="teamhead">
                                                  <option value="">Select Here</option>
                                                   <?php foreach( $this->employee_model->emselectforadmin() as $value): ?>
                                                    <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name.' '.$value->last_name; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                                <label class="control-label col-md-2">Collaborators</label>
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                               ...
                                               <input name="status" type="radio" id="radio_5" data-value="Logistic" class="type" value="open">
                                                <label for="radio_5">Open</label>
                                                ...
                                                <tbody>
                                                    <?php foreach ($files as $value) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="jsgrid-align-center ">
                                                                <?php if ($this->session->userdata('user_type') != 'EMPLOYEE') { ?>
                                                                    <a href="#" onclick="alert('Are you sure want to delet this Value?')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light filedelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
