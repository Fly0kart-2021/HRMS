                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($this->session->userdata('user_type') == 'SUPER ADMIN') {
                                            echo '<th>Assigned Department </th>';
                                        } ?>
                                        <th>Status </th>
                                        <th>Start Date </th>
                                        <th>End Date </th>
                                    ...
                                    <?php foreach ($projects as $value) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($this->session->userdata('user_type') != 'EMPLOYEE') {
                                                ...
                                                <a href="view?P=' . base64_encode($value->id) . '" title="Edit" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i></a>
                                            
                                                <a href="pDelet?D=' . base64_encode($value->id) . '" title="Delete" onclick="alert(\'' . 'Are You Want To Delete This Project!!!' . '\')" class="btn btn-sm btn-danger waves-effect waves-light projectdelet"><i class="fa fa-trash-o"></i></a>
                                            </td>';
                                            } else {
                                                echo '<td>
                                            <a href="view?P=' . base64_encode($value->id) . '" title="View" class="waves-effect waves-light"><i class="fa fa-eye"></i></a>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="startdate" class="form-control mydatepicker" id="recipient-name1" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Project End Date</label>
                                        <input type="text" name="enddate" class="form-control mydatepicker" required placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="control-label">Summery</label>
                                        <textarea class="form-control" name="summery" minlength="8" id="message-text1" placeholder=""></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    ...
                                    <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> <?php } else if ($this->session->userdata('user_type') == 'ADMIN') { ?>
                                        <div class="form-group">
                                            <?php
                                                        $depdrp = $this->session->userdata('dep_id'); ?>
                                            <!-- <label class="control-label">Department</label> -->
                                            <input name="Department" type="hidden" class="form-control" value=" <?php echo $depdrp; ?>">
                                    ...
                                    <?php } else { ?>
                                        <div class="form-group">
                                            <label class="control-label">Department</label>
                                            <select name="Department" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> readonly <?php } ?> class="form-control custom-select" required>
