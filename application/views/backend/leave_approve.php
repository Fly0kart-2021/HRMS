                        ...
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select onchange="getleavepreview();" class="form-control custom-select assignleave"  tabindex="1" name="typeid" id="leavetype" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="startdate"  autocomplete="off" class="form-control mydatetimepickerFull" id="recipient-name1" required>
                                </div>
                                <div class="form-group" id="enddate" style="display:none">
                                    <label class="control-label">End Date</label>
                                    <input type="text" autocomplete="off" name="enddate" class="form-control mydatetimepickerFull" id="recipient-name1">
                                </div>

                                <div class="form-group" style="display:none;">
                                    <label class="control-label">leftdays</label>
                                    <input type="text" autocomplete="off" name="leftdays" class="form-control" id="leftdays">
                                </div>

                                <!-- <div class="form-group" id="hourAmount" style="display:none">
                                    <label>Length</label>
...
<script>
     function getleavepreview()
{
    
    $('.fetchLeaveTotal').click();
}
    $(document).ready(function () {
        ...
        $('.fetchLeaveTotal').on('click', function (e) {
            ...
            $.ajax({
               ...
               $("#leftdays").val(arr.available);
                $("#total").html(arr.available+' days available out of '+arr.msg);
            });
        });
    });
</script>
