                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text" name="eid" class="form-control form-control-line" placeholder="ID" value="<?php echo $this->employee_model->getlastid(); 
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>NID</label>
                                        <input type="text" name="nid" class="form-control" value="" placeholder="" minlength="10" > 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
