<?php
    ...
    public function GetProjectsValue(){
        $sql = "SELECT department.dep_name,project.id,project.pro_name,pro_start_date,pro_end_date,pro_description,pro_summary,pro_status,progress,dep_id FROM `project`  left join department on project.dep_id=department.id";
