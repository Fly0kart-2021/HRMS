...
class Projects extends CI_Controller
{
	...
	function All_Projects()
	{
		...
		if ($this->session->userdata('user_login_access') != False) {
			...
			if ($this->session->userdata('user_type') == 'EMPLOYEE') {
				...
				$data['projects'] = $this->project_model->GetadminProjectsValue();
			}
			else {
				$data['projects'] = $this->project_model->GetProjectsValue();
			}
	...
	public function All_Tasks()
	{
		if ($this->session->userdata('user_login_access') != False) {
			...
			$data['tasks']    = $this->project_model->GetAllTasksList($uid);
			}else{
			$data['tasks']    = $this->project_model->GetSAdminTasksList();
			}
	...
	public function get_projectlist_by_dep()
	{
		# getting project list by current employee department
		$dep_id=$this->session->userdata('dep_id');
		$projectlist=$this->project_model->get_projectlist_by_dep($dep_id);
